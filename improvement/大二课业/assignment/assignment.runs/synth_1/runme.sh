...
HD_PWD='C:/Users/Windows/Desktop/assignment/assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Count_FFFF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Count_FFFF.tcl
