...
HD_PWD='C:/Users/Windows/Desktop/assignment/assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Count_FFFF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Count_FFFF.tcl -notrace
